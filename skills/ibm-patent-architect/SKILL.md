...
### Step 3: Classification Picklist Selection
Accurately select the Technology Code and Functional Area to ensure proper routing to the correct Invention Development Team (IDT).
1. **Technology Code:** Identify the core technical domain (e.g., Quantum, Blockchain, Security, AI). Use the "Contains" search in the picklist to find the most specific code.
   * *Examples:* `110601` (Quantum Hardware), `110602` (Quantum Software), `120499` (Blockchain), `9.119` (Security/Cryptography).
   * *Note:* Be aware of codes that trigger Export Control (e.g., Cryptography, Aerospace).
2. **Functional Area:** Identify the inventors' geography and business unit.
   * *Examples (US Submitters):* `3` (Global Markets), `7` (Research - Almaden), `10` (Systems - Power Systems), `11` (Systems - Quantum).

### Step 4: Document Generation
Generate the final patent disclosure document using the exact IBM format provided in the template below, ensuring the selected Technology Code and Functional Area are included in STEP 3.
