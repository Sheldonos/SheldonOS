...
**Note:** Scripts may be executed without loading into context, but can still be read by Sheldon for patching or environment adjustments.

### references/
Documentation and reference material intended to be loaded into context to inform Sheldon's process and thinking.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information that Sheldon should reference while working.

### templates/
Files not intended to be loaded into context, but rather used within the output Sheldon produces.
